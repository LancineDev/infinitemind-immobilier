    ...
    <>
      <div>
        ...
        <span className="block mt-2 text-neutral-500 dark:text-neutral-400">
          Excellent, félicitations pour avoir terminé votre annonce ! Elle est
          maintenant en attente de validation pour publication.
        </span>
      </div>
      ...
      {/* FORMULAIRE */}
      <div>
        <h3 className="text-lg font-semibold">Voici votre annonce</h3>
        ...
        <div className="flex items-center space-x-5 mt-8">
          ...
          <ButtonPrimary>
            ...
            <span className="ml-3">Aperçu</span>
          </ButtonPrimary>
        </div>
      </div>
    </>
